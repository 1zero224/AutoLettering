...
from autolettering.phase6_cleanup_quality import run_phase6_cleanup_quality


def main() -> None:
    parser = argparse.ArgumentParser(description="Run MIMO quality evaluation for Phase 6 cleanup before/after crops.")
