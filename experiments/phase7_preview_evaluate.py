...
from autolettering.phase7_evaluate import run_phase7_preview_evaluation


def main() -> None:
    parser = argparse.ArgumentParser(description="Run MIMO vision evaluation for Phase 7 page previews.")
    parser.add_argument("--preview-run-dir", required=True)
    ...
    run_dir = run_phase7_preview_evaluation(
        preview_run_dir=Path(args.preview_run_dir),
