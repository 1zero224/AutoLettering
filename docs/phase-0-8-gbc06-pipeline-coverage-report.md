...
phase3_font_selection  covered=23 missing=7
phase4_layout          covered=21 missing=9
phase5_angle           covered=23 missing=7
phase6_cleanup         covered=21 missing=9
phase7_preview         covered=21 missing=9
phase8_export          covered=21 missing=9
```

Group coverage:

```text
框内: base=28 complete=19
框外: base=2  complete=2
```

## Next Records

The v6 coverage report counts these records as complete across all tracked stages:
...
The next `GBC06_02.png` expansion still starts at `phase3_font_selection`. The v6
...
GBC06_02.png#9  框内  first_missing_stage=phase3_font_selection
...
The current detection prototype has already produced 30 candidate records across `GBC06_01.png` and `GBC06_02.png`. The v6 coverage tool counts 21 complete records: the initial `GBC06_01.png#1`, both non-bubble records `GBC06_01.png#16` and `#17`, the bubble records `GBC06_01.png#2` through `#13`, and `GBC06_02.png#1` through `#6`.
...
The v6 generated coverage report still lists `GBC06_01.png#14` and `#15` as missing Phase 4 in the next-record table. That is a limitation of the current merged coverage command and historical manual-readable run accounting; it does not affect the new `GBC06_02.png#4-#6` evidence. The practical next expansion target is `GBC06_02.png#7`.
