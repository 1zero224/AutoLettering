...
def build_replacement_quality_prompt(row: dict) -> str:
    ...
    return "\n".join(
        [
            ...
            "Reject if Japanese text remains in the target region, if the replacement text is placed in the wrong region, or if the replacement edits unrelated text instead of the intended target lettering.",
